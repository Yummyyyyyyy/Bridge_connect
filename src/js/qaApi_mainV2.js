...
let questionInput = document.querySelector("#qa_question");
let sendMsgBtn = document.querySelector("#qa_btn");
let result = document.querySelector("#qa_result");

let requestObj = {
    APPID: '55b0fe4c',
    APISecret: 'N2Q3NTBiYjIyN2ZlYTdhOTM0NzEzNmEw',
    APIKey: 'c7e85ccf80e508ad44b8e741402f7b6c',
