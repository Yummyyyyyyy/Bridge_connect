<template>
	...
	<el-card  class="bk2" shadow="always" style="width:80%;  margin: 0px auto;  " >
		...
		<el-form
		  ...
		  <el-form-item label="桥梁id：" prop="bridge_id" >
			...
			<el-button class="btnGroup" type="primary"   @click="submit()">提交并预测</el-button>
			</div>
			</div>
		  </el-form>
		  </el-card>
	...
	<el-dialog
		...
		<div>
			 ...
			 <el-menu
					...
					<el-menu-item index="13" class="formleft" @click="iner12 = true">梁体钢筋锈蚀</el-menu-item>
			      </el-menu>
		<!-- 	</el-col>
	...
	<!-- 		</el-col>
		...
		<!-- 		评估结果 -->
		<el-dialog v-model="evalue1"
				title="桥梁等级评估结果"
				width="70%">
				<el-card >
					 <div v-if="evaluedata">
			<h1 style="text-align: center;">桥梁预测等级为：{{ result }}</h1>
						 
				  <h3 style="text-align: center;">各个状况等级的置信度：</h3>
			<el-table :data="evaluedata2" style="width: 80% ; margin:auto auto;" 
							           :row-class-name="tableRowClassName">
			  <el-table-column prop="class1" label="等级一"></el-table-column>
			  <el-table-column prop="class2" label="等级二"></el-table-column>
			  <el-table-column prop="class3" label="等级三"></el-table-column>
			...
			<div style="width: 100% ; height:650px;"   class="evaluepi">
			</div>
...
import { resultProps } from "element-plus";
	   ...
	   var option = {
		    xAxis: {
		     ...
		     series: [
		       {
		         type: 'bar',
		         data: [this.evaluedata[0],this.evaluedata[1],this.evaluedata[2]]
		       }
		     ]
		   };
	  var myChart = echarts.init(this.$refs.mychart);// 图标初始化
	...
	submit() {
			...
			"年日均交通量": this.ruleForm.traffic || 0,
			  ...
			  "上下行":this.ruleForm.shangxiahang || 0,
			  "是否预应力桥梁":this.ruleForm.force || 0,
			  "伸缩缝混凝土开裂:10.0m平均数量": 0.0, 
			  "伸缩缝混凝土开裂:10.0m平均面积(m2)": 0.0,
			   "伸缩缝混凝土开裂:10.0m总面积(m2)": 0.0, 
			   "伸缩缝混凝土开裂:10.0m数量": 0.0,
				"伸缩缝混凝土开裂:10.0m最大面积(m2)": 0.0,
				 "伸缩缝混凝土开裂:13.0m平均数量": 0.0,
				  "伸缩缝混凝土开裂:13.0m平均面积(m2)": 0.0,
				   "伸缩缝混凝土开裂:13.0m总面积(m2)": 0.0, 
				   "伸缩缝混凝土开裂:13.0m数量": 0.0, 
				   "伸缩缝混凝土开裂:13.0m最大面积(m2)": 0.0, 
				   "伸缩缝混凝土开裂:16.0m平均数量": 0.0, 
				   "伸缩缝混凝土开裂:16.0m平均面积(m2)": 0.0,
					"伸缩缝混凝土开裂:16.0m总面积(m2)": 0.0, 
					"伸缩缝混凝土开裂:16.0m数量": 0.0, 
					"伸缩缝混凝土开裂:16.0m最大面积(m2)": 0.0,
					 "伸缩缝混凝土开裂:20.0m平均数量": 0.0, 
					 "伸缩缝混凝土开裂:20.0m平均面积(m2)": 0.0, 
					 "伸缩缝混凝土开裂:20.0m总面积(m2)": 0.0, 
					 "伸缩缝混凝土开裂:20.0m数量": 0.0, 
					 "伸缩缝混凝土开裂:20.0m最大面积(m2)": 0.0,
					  "伸缩缝混凝土开裂:8.0m平均数量": 0.0, 
					  "伸缩缝混凝土开裂:8.0m平均面积(m2)": 0.0, 
					  "伸缩缝混凝土开裂:8.0m总面积(m2)": 0.0, 
					  "伸缩缝混凝土开裂:8.0m数量": 0.0,
					   "伸缩缝混凝土开裂:8.0m最大面积(m2)": 0.0,
						"墩台裂缝:10.0m宽度总和(mm)": 0.0, 
						"墩台裂缝:10.0m平均宽度(mm)": 0.0, 
						"墩台裂缝:10.0m平均数量": 0.0,
						 "墩台裂缝:10.0m平均长度(cm)": 0.0, 
						 "墩台裂缝:10.0m数量": 0.0, 
						 "墩台裂缝:10.0m最大宽度(mm)": 0.0, 
						 "墩台裂缝:10.0m最大长度(cm)": 0.0, 
						 "墩台裂缝:10.0m长度总和(cm)": 0.0, 
						 "墩台裂缝:13.0m宽度总和(mm)": 0.0,
						  "墩台裂缝:13.0m平均宽度(mm)": 0.0,
						   "墩台裂缝:13.0m平均数量": 0.0, 
						   "墩台裂缝:13.0m平均长度(cm)": 0.0, 
						   "墩台裂缝:13.0m数量": 0.0,
							"墩台裂缝:13.0m最大宽度(mm)": 0.0,
							 "墩台裂缝:13.0m最大长度(cm)": 0.0,
							  "墩台裂缝:13.0m长度总和(cm)": 0.0, 
							  "墩台裂缝:16.0m宽度总和(mm)": 0.0, 
							  "墩台裂缝:16.0m平均宽度(mm)": 0.0, 
							  "墩台裂缝:16.0m平均数量": 0.0, 
							  "墩台裂缝:16.0m平均长度(cm)": 0.0,
							   "墩台裂缝:16.0m数量": 0.0, 
							   "墩台裂缝:16.0m最大宽度(mm)": 0.0, 
							   "墩台裂缝:16.0m最大长度(cm)": 0.0,
								"墩台裂缝:16.0m长度总和(cm)": 0.0, 
								"墩台裂缝:20.0m宽度总和(mm)": 0.0,
								 "墩台裂缝:20.0m平均宽度(mm)": 0.0,
								  "墩台裂缝:20.0m平均数量": 0.0, 
								  "墩台裂缝:20.0m平均长度(cm)": 0.0,
								   "墩台裂缝:20.0m数量": 0.0,
									"墩台裂缝:20.0m最大宽度(mm)": 0.0, 
									"墩台裂缝:20.0m最大长度(cm)": 0.0,
									"墩台裂缝:20.0m长度总和(cm)": 0.0, 
									"墩台裂缝:6.0m宽度总和(mm)": 0.0, 
									"墩台裂缝:6.0m平均宽度(mm)": 0.0, 
									"墩台裂缝:6.0m平均数量": 0.0,
									 "墩台裂缝:6.0m平均长度(cm)": 0.0, 
									 "墩台裂缝:6.0m数量": 0.0,
									  "墩台裂缝:6.0m最大宽度(mm)": 0.0, 
									  "墩台裂缝:6.0m最大长度(cm)": 0.0, 
									  "墩台裂缝:6.0m长度总和(cm)": 0.0, 
									  "墩台裂缝:8.0m宽度总和(mm)": 0.0, 
									  "墩台裂缝:8.0m平均宽度(mm)": 0.0, 
									  "墩台裂缝:8.0m平均数量": 0.0, 
									  "墩台裂缝:8.0m平均长度(cm)": 0.0, 
									  "墩台裂缝:8.0m数量": 0.0, 
									  "墩台裂缝:8.0m最大宽度(mm)": 0.0, 
									  "墩台裂缝:8.0m最大长度(cm)": 0.0, 
									  "墩台裂缝:8.0m长度总和(cm)": 0.0, 
									  "墩台钢筋锈蚀:10.0m平均数量": 0.0, 
									  "墩台钢筋锈蚀:10.0m平均长度((m))": 0.0,
									 "墩台钢筋锈蚀:10.0m数量": 0.0,
									"墩台钢筋锈蚀:10.0m最大长度(m)": 0.0,
									 "墩台钢筋锈蚀:10.0m长度总和(m)": 0.0,
									  "墩台钢筋锈蚀:13.0m平均数量": 0.0, 
									  "墩台钢筋锈蚀:13.0m平均长度((m))": 0.0, 
									  "墩台钢筋锈蚀:13.0m数量": 0.0,
									  "墩台钢筋锈蚀:13.0m最大长度(m)": 0.0, 
									  "墩台钢筋锈蚀:13.0m长度总和(m)": 0.0, 
									  "墩台钢筋锈蚀:16.0m平均数量": 0.0, 
									  "墩台钢筋锈蚀:16.0m平均长度((m))": 0.0, 
									  "墩台钢筋锈蚀:16.0m数量": 0.0, 
									  "墩台钢筋锈蚀:16.0m最大长度(m)": 0.0,
									  "墩台钢筋锈蚀:16.0m长度总和(m)": 0.0,
									  "墩台钢筋锈蚀:20.0m平均数量": 1.25, 
									  "墩台钢筋锈蚀:20.0m平均长度((m))": 0.25, 
									  "墩台钢筋锈蚀:20.0m数量": 5.0, 
									  "墩台钢筋锈蚀:20.0m最大长度(m)": 0.5, 
									  "墩台钢筋锈蚀:20.0m长度总和(m)": 1.0, 
									  "墩台钢筋锈蚀:6.0m平均数量": 0.0, 
									  "墩台钢筋锈蚀:6.0m平均长度((m))": 0.0, 
									  "墩台钢筋锈蚀:6.0m数量": 0.0, 
									  "墩台钢筋锈蚀:6.0m最大长度(m)": 0.0, "墩台钢筋锈蚀:6.0m长度总和(m)": 0.0, "墩台钢筋锈蚀:8.0m平均数量": 0.0, 
									  "墩台钢筋锈蚀:8.0m平均长度((m))": 0.0, "墩台钢筋锈蚀:8.0m数量": 0.0, 
									  "墩台钢筋锈蚀:8.0m最大长度(m)": 0.0, "墩台钢筋锈蚀:8.0m长度总和(m)": 0.0, 
									  "支座变形:10.0m平均数量": 0.0, "支座变形:10.0m数量": 0.0,
									  "支座变形:13.0m平均数量": 0.0, "支座变形:13.0m数量": 0.0, 
									  "支座变形:16.0m平均数量": 0.0, "支座变形:16.0m数量": 0.0, 
									  "支座变形:20.0m平均数量": 0.0, "支座变形:20.0m数量": 0.0, 
									  "支座变形:8.0m平均数量": 0.0, "支座变形:8.0m数量": 0.0, 
									  "支座开裂:10.0m宽度总和(mm)": 0.0, "支座开裂:10.0m平均宽度(mm)": 0.0, 
									  "支座开裂:10.0m平均数量": 0.0, "支座开裂:10.0m平均长度(cm)": 0.0, 
									  "支座开裂:10.0m数量": 0.0, "支座开裂:10.0m最大宽度(mm)": 0.0, 
									  "支座开裂:10.0m最大长度(cm)": 0.0, "支座开裂:10.0m长度总和(cm)": 0.0, 
									  "支座开裂:13.0m宽度总和(mm)": 0.0, "支座开裂:13.0m平均宽度(mm)": 0.0, 
									  "支座开裂:13.0m平均数量": 0.0, "支座开裂:13.0m平均长度(cm)": 0.0,
									   "支座开裂:13.0m数量": 0.0, "支座开裂:13.0m最大宽度(mm)": 0.0, 
									   "支座开裂:13.0m最大长度(cm)": 0.0, "支座开裂:13.0m长度总和(cm)": 0.0,
										"支座开裂:16.0m宽度总和(mm)": 0.0, "支座开裂:16.0m平均宽度(mm)": 0.0, 
										"支座开裂:16.0m平均数量": 0.0, "支座开裂:16.0m平均长度(cm)": 0.0, 
										"支座开裂:16.0m数量": 0.0, "支座开裂:16.0m最大宽度(mm)": 0.0,
										 "支座开裂:16.0m最大长度(cm)": 0.0, 
										 "支座开裂:16.0m长度总和(cm)": 0.0, "支座开裂:20.0m宽度总和(mm)": 0.0, 
										 "支座开裂:20.0m平均宽度(mm)": 0.0, "支座开裂:20.0m平均数量": 0.0, 
										 "支座开裂:20.0m平均长度(cm)": 0.0, "支座开裂:20.0m数量": 0.0, "支座开裂:20.0m最大宽度(mm)": 0.0,
										  "支座开裂:20.0m最大长度(cm)": 0.0, "支座开裂:20.0m长度总和(cm)": 0.0, "支座开裂:8.0m宽度总和(mm)": 0.0, "支座开裂:8.0m平均宽度(mm)": 0.0,
										   "支座开裂:8.0m平均数量": 0.0, "支座开裂:8.0m平均长度(cm)": 0.0, "支座开裂:8.0m数量": 0.0, "支座开裂:8.0m最大宽度(mm)": 0.0, "支座开裂:8.0m最大长度(cm)": 0.0, "支座开裂:8.0m长度总和(cm)": 0.0, 
										   "支座脱空:10.0m平均数量": 0.0, "支座脱空:10.0m数量": 0.0, "支座脱空:13.0m平均数量": 0.0, "支座脱空:13.0m数量": 0.0, "支座脱空:16.0m平均数量": 0.0, "支座脱空:16.0m数量": 0.0,
											"支座脱空:20.0m平均数量": 0.0, "支座脱空:20.0m数量": 0.0,
											 "支座脱空:8.0m平均数量": 0.0, "支座脱空:8.0m数量": 0.0, "梁体底板横向裂缝:10.0m宽度总和(mm)": 0.0, "梁体底板横向裂缝:10.0m平均宽度(mm)": 0.0, 
											 "梁体底板横向裂缝:10.0m平均数量": 0.0, "梁体底板横向裂缝:10.0m平均长度(cm)": 0.0, "梁体底板横向裂缝:10.0m数量": 0.0, "梁体底板横向裂缝:10.0m最大宽度(mm)": 0.0,
											  "梁体底板横向裂缝:10.0m最大长度占比": 0.0, "梁体底板横向裂缝:10.0m每延米数量": 0.0, "梁体底板横向裂缝:10.0m长度总和(cm)": 0.0, 
											  "梁体底板横向裂缝:13.0m宽度总和(mm)": 0.0, "梁体底板横向裂缝:13.0m平均宽度(mm)": 0.0,
											   "梁体底板横向裂缝:13.0m平均数量": 0.0, "梁体底板横向裂缝:13.0m平均长度(cm)": 0.0, 
											   "梁体底板横向裂缝:13.0m数量": 0.0, "梁体底板横向裂缝:13.0m最大宽度(mm)": 0.0, "梁体底板横向裂缝:13.0m最大长度占比": 0.0, 
											   "梁体底板横向裂缝:13.0m每延米数量": 0.0, "梁体底板横向裂缝:13.0m长度总和(cm)": 0.0, "梁体底板横向裂缝:16.0m宽度总和(mm)": 0.0, "梁体底板横向裂缝:16.0m平均宽度(mm)": 0.0, "梁体底板横向裂缝:16.0m平均数量": 0.0, 
											   "梁体底板横向裂缝:16.0m平均长度(cm)": 0.0, "梁体底板横向裂缝:16.0m数量": 0.0, "梁体底板横向裂缝:16.0m最大宽度(mm)": 0.0, "梁体底板横向裂缝:16.0m最大长度占比": 0.0, "梁体底板横向裂缝:16.0m每延米数量": 0.0, "梁体底板横向裂缝:16.0m长度总和(cm)": 0.0,
												"梁体底板横向裂缝:20.0m宽度总和(mm)": 0.0, "梁体底板横向裂缝:20.0m平均宽度(mm)": 0.0, "梁体底板横向裂缝:20.0m平均数量": 0.0, "梁体底板横向裂缝:20.0m平均长度(cm)": 0.0, "梁体底板横向裂缝:20.0m数量": 0.0, "梁体底板横向裂缝:20.0m最大宽度(mm)": 0.0,
												 "梁体底板横向裂缝:20.0m最大长度占比": 0.0, "梁体底板横向裂缝:20.0m每延米数量": 0.0, "梁体底板横向裂缝:20.0m长度总和(cm)": 0.0, "梁体底板横向裂缝:8.0m宽度总和(mm)": 0.0, "梁体底板横向裂缝:8.0m平均宽度(mm)": 0.0, "梁体底板横向裂缝:8.0m平均数量": 0.0, "梁体底板横向裂缝:8.0m平均长度(cm)": 0.0, "梁体底板横向裂缝:8.0m数量": 0.0, 
												 "梁体底板横向裂缝:8.0m最大宽度(mm)": 0.0, "梁体底板横向裂缝:8.0m最大长度占比": 0.0, "梁体底板横向裂缝:8.0m每延米数量": 0.0, "梁体底板横向裂缝:8.0m长度总和(cm)": 0.0, "梁体底板混凝土破损:10.0m平均数量": 0.0, "梁体底板混凝土破损:10.0m平均面积(m2)": 0.0, 
												 "梁体底板混凝土破损:10.0m总面积(m2)": 0.0, "梁体底板混凝土破损:10.0m数量": 0.0, "梁体底板混凝土破损:10.0m最大面积(m2)": 0.0, "梁体底板混凝土破损:13.0m平均数量": 0.0, "梁体底板混凝土破损:13.0m平均面积(m2)": 0.0, "梁体底板混凝土破损:13.0m总面积(m2)": 0.0, "梁体底板混凝土破损:13.0m数量": 0.0, "梁体底板混凝土破损:13.0m最大面积(m2)": 0.0, "梁体底板混凝土破损:16.0m平均数量": 0.0, "梁体底板混凝土破损:16.0m平均面积(m2)": 0.0, 
												 "梁体底板混凝土破损:16.0m总面积(m2)": 0.0, "梁体底板混凝土破损:16.0m数量": 0.0, "梁体底板混凝土破损:16.0m最大面积(m2)": 0.0, "梁体底板混凝土破损:20.0m平均数量": 2.75, "梁体底板混凝土破损:20.0m平均面积(m2)": 0.0, "梁体底板混凝土破损:20.0m总面积(m2)": 0.0, "梁体底板混凝土破损:20.0m数量": 11.0, "梁体底板混凝土破损:20.0m最大面积(m2)": 0.0, "梁体底板混凝土破损:6.0m平均数量": 0.0, "梁体底板混凝土破损:6.0m平均面积(m2)": 0.0, "梁体底板混凝土破损:6.0m总面积(m2)": 0.0,
												  "梁体底板混凝土破损:6.0m数量": 0.0, "梁体底板混凝土破损:6.0m最大面积(m2)": 0.0, "梁体底板混凝土破损:8.0m平均数量": 0.0, "梁体底板混凝土破损:8.0m平均面积(m2)": 0.0, "梁体底板混凝土破损:8.0m总面积(m2)": 0.0, "梁体底板混凝土破损:8.0m数量": 0.0, "梁体底板混凝土破损:8.0m最大面积(m2)": 0.0, "梁体底板纵向裂缝:10.0m宽度总和(mm)": 0.0, "梁体底板纵向裂缝:10.0m平均宽度(mm)": 0.0, "梁体底板纵向裂缝:10.0m平均数量": 0.0, "梁体底板纵向裂缝:10.0m平均长度(cm)": 0.0, "梁体底板纵向裂缝:10.0m数量": 0.0, "梁体底板纵向裂缝:10.0m最大宽度(mm)": 0.0, "梁体底板纵向裂缝:10.0m最大长度占比": 0.0,
												   "梁体底板纵向裂缝:10.0m长度总和(cm)": 0.0, "梁体底板纵向裂缝:13.0m宽度总和(mm)": 0.0, "梁体底板纵向裂缝:13.0m平均宽度(mm)": 0.0, "梁体底板纵向裂缝:13.0m平均数量": 0.0, "梁体底板纵向裂缝:13.0m平均长度(cm)": 0.0, "梁体底板纵向裂缝:13.0m数量": 0.0, "梁体底板纵向裂缝:13.0m最大宽度(mm)": 0.0, "梁体底板纵向裂缝:13.0m最大长度占比": 0.0, "梁体底板纵向裂缝:13.0m长度总和(cm)": 0.0, "梁体底板纵向裂缝:16.0m宽度总和(mm)": 0.0, 
												   "梁体底板纵向裂缝:16.0m平均宽度(mm)": 0.0, "梁体底板纵向裂缝:16.0m平均数量": 0.0, "梁体底板纵向裂缝:16.0m平均长度(cm)": 0.0, "梁体底板纵向裂缝:16.0m数量": 0.0, "梁体底板纵向裂缝:16.0m最大宽度(mm)": 0.0, "梁体底板纵向裂缝:16.0m最大长度占比": 0.0, "梁体底板纵向裂缝:16.0m长度总和(cm)": 0.0, "梁体底板纵向裂缝:20.0m宽度总和(mm)": 0.0, "梁体底板纵向裂缝:20.0m平均宽度(mm)": 0.0, "梁体底板纵向裂缝:20.0m平均数量": 0.0, "梁体底板纵向裂缝:20.0m平均长度(cm)": 0.0, "梁体底板纵向裂缝:20.0m数量": 0.0, "梁体底板纵向裂缝:20.0m最大宽度(mm)": 0.0, "梁体底板纵向裂缝:20.0m最大长度占比": 0.0, "梁体底板纵向裂缝:20.0m长度总和(cm)": 0.0, 
												   "梁体底板纵向裂缝:8.0m宽度总和(mm)": 0.0, "梁体底板纵向裂缝:8.0m平均宽度(mm)": 0.0, "梁体底板纵向裂缝:8.0m平均数量": 0.0, "梁体底板纵向裂缝:8.0m平均长度(cm)": 0.0, "梁体底板纵向裂缝:8.0m数量": 0.0, "梁体底板纵向裂缝:8.0m最大宽度(mm)": 0.0, "梁体底板纵向裂缝:8.0m最大长度占比": 0.0, "梁体底板纵向裂缝:8.0m长度总和(cm)": 0.0, "梁体翼板横向裂缝:10.0m宽度总和(mm)": 0.0, "梁体翼板横向裂缝:10.0m平均宽度(mm)": 0.0, "梁体翼板横向裂缝:10.0m平均数量": 0.0, "梁体翼板横向裂缝:10.0m平均长度(cm)": 0.0, "梁体翼板横向裂缝:10.0m平均间距": 0.0, "梁体翼板横向裂缝:10.0m数量": 0.0, "梁体翼板横向裂缝:10.0m最大宽度(mm)": 0.0, 
												   "梁体翼板横向裂缝:10.0m最大长度(cm)": 0.0, "梁体翼板横向裂缝:10.0m长度总和(cm)": 0.0, "梁体翼板横向裂缝:13.0m宽度总和(mm)": 0.0, "梁体翼板横向裂缝:13.0m平均宽度(mm)": 0.0, "梁体翼板横向裂缝:13.0m平均数量": 0.0, "梁体翼板横向裂缝:13.0m平均长度(cm)": 0.0, "梁体翼板横向裂缝:13.0m平均间距": 0.0, "梁体翼板横向裂缝:13.0m数量": 0.0, "梁体翼板横向裂缝:13.0m最大宽度(mm)": 0.0,
													"梁体翼板横向裂缝:13.0m最大长度(cm)": 0.0, "梁体翼板横向裂缝:13.0m长度总和(cm)": 0.0, "梁体翼板横向裂缝:16.0m宽度总和(mm)": 0.0, "梁体翼板横向裂缝:16.0m平均宽度(mm)": 0.0, "梁体翼板横向裂缝:16.0m平均数量": 0.0, "梁体翼板横向裂缝:16.0m平均长度(cm)": 0.0, "梁体翼板横向裂缝:16.0m平均间距": 0.0, "梁体翼板横向裂缝:16.0m数量": 0.0, "梁体翼板横向裂缝:16.0m最大宽度(mm)": 0.0, "梁体翼板横向裂缝:16.0m最大长度(cm)": 0.0, "梁体翼板横向裂缝:16.0m长度总和(cm)": 0.0, "梁体翼板横向裂缝:20.0m宽度总和(mm)": 0.0, "梁体翼板横向裂缝:20.0m平均宽度(mm)": 0.0, "梁体翼板横向裂缝:20.0m平均数量": 0.0, "梁体翼板横向裂缝:20.0m平均长度(cm)": 0.0, "梁体翼板横向裂缝:20.0m平均间距": 0.0, "梁体翼板横向裂缝:20.0m数量": 0.0, 
													"梁体翼板横向裂缝:20.0m最大宽度(mm)": 0.0, "梁体翼板横向裂缝:20.0m最大长度(cm)": 0.0, "梁体翼板横向裂缝:20.0m长度总和(cm)": 0.0, "梁体翼板横向裂缝:8.0m宽度总和(mm)": 0.0, "梁体翼板横向裂缝:8.0m平均宽度(mm)": 0.0, "梁体翼板横向裂缝:8.0m平均数量": 0.0, "梁体翼板横向裂缝:8.0m平均长度(cm)": 0.0, "梁体翼板横向裂缝:8.0m平均间距": 0.0, "梁体翼板横向裂缝:8.0m数量": 0.0, "梁体翼板横向裂缝:8.0m最大宽度(mm)": 0.0, "梁体翼板横向裂缝:8.0m最大长度(cm)": 0.0, "梁体翼板横向裂缝:8.0m长度总和(cm)": 0.0, "梁体腹板混凝土破损:10.0m平均数量": 0.0, "梁体腹板混凝土破损:10.0m平均面积(m2)": 0.0, "梁体腹板混凝土破损:10.0m总面积(m2)": 0.0, "梁体腹板混凝土破损:10.0m数量": 0.0,
													 "梁体腹板混凝土破损:10.0m最大面积(m2)": 0.0, "梁体腹板混凝土破损:13.0m平均数量": 0.0, "梁体腹板混凝土破损:13.0m平均面积(m2)": 0.0, 
													"梁体腹板混凝土破损:13.0m总面积(m2)": 0.0, "梁体腹板混凝土破损:13.0m数量": 0.0, "梁体腹板混凝土破损:13.0m最大面积(m2)": 0.0, "梁体腹板混凝土破损:16.0m平均数量": 0.0, "梁体腹板混凝土破损:16.0m平均面积(m2)": 0.0, "梁体腹板混凝土破损:16.0m总面积(m2)": 0.0, "梁体腹板混凝土破损:16.0m数量": 0.0, "梁体腹板混凝土破损:16.0m最大面积(m2)": 0.0,
													 "梁体腹板混凝土破损:20.0m平均数量": 0.0, "梁体腹板混凝土破损:20.0m平均面积(m2)": 0.0, "梁体腹板混凝土破损:20.0m总面积(m2)": 0.0, "梁体腹板混凝土破损:20.0m数量": 0.0, "梁体腹板混凝土破损:20.0m最大面积(m2)": 0.0, "梁体腹板混凝土破损:8.0m平均数量": 0.0, "梁体腹板混凝土破损:8.0m平均面积(m2)": 0.0, "梁体腹板混凝土破损:8.0m总面积(m2)": 0.0, "梁体腹板混凝土破损:8.0m数量": 0.0, "梁体腹板混凝土破损:8.0m最大面积(m2)": 0.0,
													  "梁体腹板竖向裂缝:10.0m宽度总和(mm)": 0.0, "梁体腹板竖向裂缝:10.0m平均宽度(mm)": 0.0, "梁体腹板竖向裂缝:10.0m平均数量": 0.0, "梁体腹板竖向裂缝:10.0m平均长度(cm)": 0.0, "梁体腹板竖向裂缝:10.0m数量": 0.0, "梁体腹板竖向裂缝:10.0m最大宽度(mm)": 0.0, "梁体腹板竖向裂缝:10.0m最大长度占比": 0.0, 
													  "梁体腹板竖向裂缝:10.0m长度总和(cm)": 0.0, "梁体腹板竖向裂缝:13.0m宽度总和(mm)": 0.0, "梁体腹板竖向裂缝:13.0m平均宽度(mm)": 0.0, "梁体腹板竖向裂缝:13.0m平均数量": 0.0, "梁体腹板竖向裂缝:13.0m平均长度(cm)": 0.0, "梁体腹板竖向裂缝:13.0m数量": 0.0, "梁体腹板竖向裂缝:13.0m最大宽度(mm)": 0.0,
													   "梁体腹板竖向裂缝:13.0m最大长度占比": 0.0, "梁体腹板竖向裂缝:13.0m长度总和(cm)": 0.0, "梁体腹板竖向裂缝:16.0m宽度总和(mm)": 0.0, "梁体腹板竖向裂缝:16.0m平均宽度(mm)": 0.0, "梁体腹板竖向裂缝:16.0m平均数量": 0.0, "梁体腹板竖向裂缝:16.0m平均长度(cm)": 0.0, "梁体腹板竖向裂缝:16.0m数量": 0.0, "梁体腹板竖向裂缝:16.0m最大宽度(mm)": 0.0,
														"梁体腹板竖向裂缝:16.0m最大长度占比": 0.0, "梁体腹板竖向裂缝:16.0m长度总和(cm)": 0.0, "梁体腹板竖向裂缝:20.0m宽度总和(mm)": 0.0, "梁体腹板竖向裂缝:20.0m平均宽度(mm)": 0.0, "梁体腹板竖向裂缝:20.0m平均数量": 0.5, "梁体腹板竖向裂缝:20.0m平均长度(cm)": 0.0, "梁体腹板竖向裂缝:20.0m数量": 2.0, "梁体腹板竖向裂缝:20.0m最大宽度(mm)": 0.0,
														 "梁体腹板竖向裂缝:20.0m最大长度占比": 0.0, "梁体腹板竖向裂缝:20.0m长度总和(cm)": 0.0, "梁体腹板竖向裂缝:8.0m宽度总和(mm)": 0.0, "梁体腹板竖向裂缝:8.0m平均宽度(mm)": 0.0, "梁体腹板竖向裂缝:8.0m平均数量": 0.0, "梁体腹板竖向裂缝:8.0m平均长度(cm)": 0.0, "梁体腹板竖向裂缝:8.0m数量": 0.0, "梁体腹板竖向裂缝:8.0m最大宽度(mm)": 0.0, "梁体腹板竖向裂缝:8.0m最大长度占比": 0.0, "梁体腹板竖向裂缝:8.0m长度总和(cm)": 0.0, 
														 "梁体钢筋锈蚀:10.0m平均数量": 0.0, "梁体钢筋锈蚀:10.0m平均长度((m))": 0.0, "梁体钢筋锈蚀:10.0m数量": 0.0, "梁体钢筋锈蚀:10.0m最大长度(m)": 0.0, "梁体钢筋锈蚀:10.0m长度总和(m)": 0.0, "梁体钢筋锈蚀:13.0m平均数量": 0.0, "梁体钢筋锈蚀:13.0m平均长度((m))": 0.0, "梁体钢筋锈蚀:13.0m数量": 0.0, "梁体钢筋锈蚀:13.0m最大长度(m)": 0.0, "梁体钢筋锈蚀:13.0m长度总和(m)": 0.0, "梁体钢筋锈蚀:16.0m平均数量": 0.0, "梁体钢筋锈蚀:16.0m平均长度((m))": 0.0, "梁体钢筋锈蚀:16.0m数量": 0.0, "梁体钢筋锈蚀:16.0m最大长度(m)": 0.0, "梁体钢筋锈蚀:16.0m长度总和(m)": 0.0, "梁体钢筋锈蚀:20.0m平均数量": 0.0, "梁体钢筋锈蚀:20.0m平均长度((m))": 0.0, "梁体钢筋锈蚀:20.0m数量": 0.0, "梁体钢筋锈蚀:20.0m最大长度(m)": 0.0, 
														 "梁体钢筋锈蚀:20.0m长度总和(m)": 0.0, "梁体钢筋锈蚀:6.0m平均数量": 0.0, "梁体钢筋锈蚀:6.0m平均长度((m))": 0.0, "梁体钢筋锈蚀:6.0m数量": 0.0, "梁体钢筋锈蚀:6.0m最大长度(m)": 0.0, "梁体钢筋锈蚀:6.0m长度总和(m)": 0.0, "梁体钢筋锈蚀:8.0m平均数量": 0.0, "梁体钢筋锈蚀:8.0m平均长度((m))": 0.0, "梁体钢筋锈蚀:8.0m数量": 0.0, "梁体钢筋锈蚀:8.0m最大长度(m)": 0.0, 
											"梁体钢筋锈蚀:8.0m长度总和(m)": 0.0
			
				},
			    }).then(res=>{
					console.log(res)
					console.log(res.data)
					this.evaluedata = res.data; 
					let max=0;
					let index = -1;
					for (let i = 0; i < 3; i++) {
						this.evaluedata[i] = (parseFloat(this.evaluedata[i]) / 100).toFixed(2);
					    if ( max< this.evaluedata[i]) {
					        max =this.evaluedata[i] ;
					        index = i+1;
					     }
					 
					}
					this.evaluedata2=[];
					this.evaluedata2.push({ class1:this.evaluedata[0],
					                        class2:this.evaluedata[1],
											class3:this.evaluedata[2]
											});
					this.result=index;
...
<style>
	...
	.evaluepi{
		/*background-image: url("../../public/picture/evaluetu.png");*/
